...
import { Save, Gem, User, Palette } from 'lucide-react';  
  ...
  return (  
    ...
    >  
      <div className="flex items-center gap-3 mb-6">  
        ...
        <h2 className="text-2xl font-semibold text-gray-800">Nuevo Proyecto Pavé</h2>  
      </div>  
  
      <form onSubmit={handleSubmit} className="space-y-6">  
        <div>  
          <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">  
            <Gem className="w-4 h-4" /> Nombre del Proyecto  
          </label>  
          <input  
            type="text"  
            name="projectName"  
        ...
        <div>  
          <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">  
            <Gem className="w-4 h-4" /> Cantidad de Gemas  
          </label>  
          <input  
            type="number"  
            name="gemsQuantity"  
      ...
      {submitted && (  
        ...
        >  
          ¡Pavé listo y guardado! Tus gemas ahora tienen hogar.  
        </motion.div>  
      )}  
    </motion.div>  
  );  
